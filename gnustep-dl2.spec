...
danych GNUstepa, to zbiór bibliotek odwzorowujących obiekty
Objective-C na wiersze relacyjnych baz danych. Celem jest osiągnięcie
zgodności z Enterprise Object Framework (EOF) wydanym wraz z
